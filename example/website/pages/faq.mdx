...
v5 requires React Native 0.80+, Reanimated 4.1+, and React Native Worklets 0.5+. See the [v5 migration guide](/migration-v5) for the validated Expo matrix and setup notes.
