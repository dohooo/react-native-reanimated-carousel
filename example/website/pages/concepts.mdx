...
![steps-1](../../../docs/assets/steps-1.png)
2. When we drag the image to the right

![steps-2](../../../docs/assets/steps-2.png)

![steps-3](../../../docs/assets/steps-3.png)

3. When the first image is partially in the viewport, we move the last image to the front

![steps-4](../../../docs/assets/steps-4.png)
...
![steps-5](../../../docs/assets/steps-5.png)
...
![steps-8](../../../docs/assets/steps-8.jpeg)
